export const it = {
  translation: {
    ...
    aiPanel: {
      ...
      sendingRequest: "Invio della richiesta…",
      requestFailed: "La richiesta AI non è riuscita.",
      requestTimedOut: "La richiesta AI è scaduta.",
      patternBuilder: "Schema riga",
      patternGap: "Separatore schema",
      fieldPrefix: "Prefisso del campo",
      fieldSuffix: "Suffisso del campo",
      fieldPrefixNamed: "Prefisso di {{field}}",
      fieldSuffixNamed: "Suffisso di {{field}}",
      patternSeparator: "Separatore del modello",
