export const pt = {
  translation: {
    ...
    aiPanel: {
      ...
      fieldPrefix: "Prefixo do campo",
      fieldSuffix: "Sufixo do campo",
      fieldPrefixNamed: "Prefixo de {{field}}",
      fieldSuffixNamed: "Sufixo de {{field}}",
      patternSeparator: "Separador do padrão",
