export const es = {
  translation: {
    ...
    aiPanel: {
      ...
      fieldPrefix: "Prefijo del campo",
      fieldSuffix: "Sufijo del campo",
      fieldPrefixNamed: "Prefijo de {{field}}",
      fieldSuffixNamed: "Sufijo de {{field}}",
      patternSeparator: "Separador del patrón",
