export const fr = {
  translation: {
    ...
    aiPanel: {
      ...
      requestFailed: "La requête d’IA a échoué.",
      requestTimedOut: "La requête d’IA a expiré.",
      patternBuilder: "Modèle de ligne",
      patternGap: "Séparateur de modèle",
      fieldPrefix: "Préfixe du champ",
      fieldSuffix: "Suffixe du champ",
      fieldPrefixNamed: "Préfixe de {{field}}",
      fieldSuffixNamed: "Suffixe de {{field}}",
      patternSeparator: "Séparateur du motif",
