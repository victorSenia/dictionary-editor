export const uk = {
  translation: {
    ...
    aiPanel: {
      ...
      fieldPrefix: "Префікс поля",
      fieldSuffix: "Суфікс поля",
      fieldPrefixNamed: "Префікс поля «{{field}}»",
      fieldSuffixNamed: "Суфікс поля «{{field}}»",
      patternSeparator: "Роздільник шаблону",
