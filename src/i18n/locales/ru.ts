export const ru = {
  translation: {
    ...
    aiPanel: {
      ...
      fieldPrefix: "Префикс поля",
      fieldSuffix: "Суффикс поля",
      fieldPrefixNamed: "Префикс поля «{{field}}»",
      fieldSuffixNamed: "Суффикс поля «{{field}}»",
      patternSeparator: "Разделитель шаблона",
