export const nl = {
  translation: {
    ...
    aiPanel: {
      ...
      sendingRequest: "Verzoek wordt verzonden…",
      requestFailed: "Het AI-verzoek is mislukt.",
      requestTimedOut: "Er is een time-out opgetreden bij het AI-verzoek.",
      patternBuilder: "Regelpatroon",
      patternGap: "Patroonscheiding",
      fieldPrefix: "Veldvoorvoegsel",
      fieldSuffix: "Veldachtervoegsel",
      fieldPrefixNamed: "{{field}}-voorvoegsel",
      fieldSuffixNamed: "{{field}}-achtervoegsel",
      patternSeparator: "Patroonscheiding",
